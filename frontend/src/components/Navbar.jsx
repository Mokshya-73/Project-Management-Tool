...
const Navbar = () => {
  ...
  return (
    <>
      <header className="flex justify-between sticky top-0 p-4 bg-white shadow-sm items-center font-bold">
        <h2 className="cursor-pointer uppercase font-semibold bg-sky-100 text-2xl ">
        ...
        <ul className="hidden md:flex gap-4 uppercase font-medium">
          {authState.isLoggedIn ? (
            ...
            <li className="py-2 px-3 cursor-pointer text-sky-700 bg-slate-100  hover:bg-gray-200 transition rounded-sm text-1xl">
        ...
        >
          ...
          <ul className="flex flex-col gap-4 uppercase font-medium text-center">
            {authState.isLoggedIn ? (
              ...
              <li className="py-2 px-3 cursor-pointer text-sky-700 border-stone-700 hover:bg-gray-200 transition rounded-sm">
                <Link to="/login">Login</Link>
              </li>
            )}
          </ul>
